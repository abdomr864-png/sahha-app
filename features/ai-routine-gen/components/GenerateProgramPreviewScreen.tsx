...
export function GenerateProgramPreviewScreen() {
  ...
  const onSave = async () => {
    ...
    try {
      ...
      discard();
      // Refresh program-existence + the routines list so the home CTA flips to
      // "Let's continue" and the new program is visible immediately on return.
      await Promise.all([
        qc.invalidateQueries({ queryKey: ['has-program'] }),
        qc.invalidateQueries({ queryKey: ['saved-routines'] }),
      ]);
    ...
    <Pressable onPress={() => setOpen((o) => !o)} className="mb-2.5">
      <View
        ...
        style={{
          backgroundColor: '#17171B',
          borderWidth: 1,
          borderColor: open ? `${dayColor.from}50` : '#21212B',
        }}
      >
        ...
        <View className="flex-row items-center p-3">
          ...
          <View
            ...
            style={{
              ...
              borderWidth: 1,
              borderColor: open ? 'rgba(249,115,22,0.3)' : '#21212B',
            }}
          >
            <Icon
              name={open ? 'chevron-down' : 'chevron-right'}
              size={13}
              color={open ? ACCENT : '#B4B4C2'}
            />
          </View>
        </View>
...
function ExerciseRow({
  ...
  const imageUrl = imageUrlFor(ex.name, 0, ex.muscle_group);
  ...
  return (
    ...
    >
      ...
      >
        <Icon name="chevron-right" size={11} color="#B4B4C2" />
      </View>
    </Pressable>
  );
}
  ...
  return (
    <View
      ...
      style={{
        ...
        borderWidth: 1,
        borderColor: primary ? 'rgba(249,115,22,0.3)' : '#21212B',
      }}
    >
      <Text
        className="font-extrabold"
...
function SecondaryCTA({
  ...
  return (
    ...
    >
      <Icon name="bookmark" size={14} color="#B4B4C2" />
